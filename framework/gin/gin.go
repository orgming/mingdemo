...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/github.com/orgming/mingdemo/framework/gin#readme-don-t-trust-all-proxies for details.")
	}
...
func (engine *Engine) RunUnix(file string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://github.com/orgming/mingdemo/framework/gin/blob/master/docs/doc.md#dont-trust-all-proxies for details.")
	}
