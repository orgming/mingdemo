...
func (m *MemoryCache) SetForeverObj(ctx context.Context, key string, val any) error {
	return m.SetObj(ctx, key, val, NoneDuration)
}

func (m *MemoryCache) Remember(ctx context.Context, key string, timeout time.Duration, rememberFunc contract.RememberFunc, obj any) error {
