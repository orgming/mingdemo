...
func NewMingSSH(params ...any) (any, error) {
...
func (app *MingSSH) GetClient(option ...contract.SSHOption) (*ssh.Client, error) {
	...
	if err != nil {
		logService.Error(context.Background(), "ssh dial error", map[string]any{
			"err":  err,
			"addr": addr,
		})
	}
